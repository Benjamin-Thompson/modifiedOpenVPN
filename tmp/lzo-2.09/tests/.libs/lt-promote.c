...
/* tests/.libs/lt-promote.c - temporary wrapper executable for .libs/promote.exe
   Generated by libtool (GNU libtool) 2.4.2.418

   The tests/promote program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "promote.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# tests/promote - temporary wrapper script for .libs/promote.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2.418\n", f);
  fputs ("#\n", f);
  fputs ("# The tests/promote program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"promote.exe:tests/promote:$LINENO: libtool wrapper (GNU libtool) 2.4.", f);
  fputs ("2.418\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"promote.exe:tests/promote:$LINENO: newargv[$lt_dump_args_N]: $lt_arg", f);
  fputs ("\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"promote.exe:tests/promote:$LINENO: newargv[0]: $progdir/$program", f);
  fputs ("\" 1>&2\n", f);
