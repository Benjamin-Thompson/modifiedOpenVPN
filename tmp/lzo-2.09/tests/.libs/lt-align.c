...
/* tests/.libs/lt-align.c - temporary wrapper executable for .libs/align.exe
   Generated by libtool (GNU libtool) 2.4.2.418

   The tests/align program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "align.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# tests/align - temporary wrapper script for .libs/align.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2.418\n", f);
  fputs ("#\n", f);
  fputs ("# The tests/align program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"align.exe:tests/align:$LINENO: libtool wrapper (GNU libtool) 2.4.2.41", f);
  fputs ("8\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"align.exe:tests/align:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"align.exe:tests/align:$LINENO: newargv[0]: $progdir/$program\" 1>", f);
  fputs ("&2\n", f);
