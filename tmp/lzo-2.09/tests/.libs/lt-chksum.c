...
/* tests/.libs/lt-chksum.c - temporary wrapper executable for .libs/chksum.exe
   Generated by libtool (GNU libtool) 2.4.2.418

   The tests/chksum program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "chksum.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# tests/chksum - temporary wrapper script for .libs/chksum.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2.418\n", f);
  fputs ("#\n", f);
  fputs ("# The tests/chksum program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"chksum.exe:tests/chksum:$LINENO: libtool wrapper (GNU libtool) 2.4.2.", f);
  fputs ("418\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"chksum.exe:tests/chksum:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"chksum.exe:tests/chksum:$LINENO: newargv[0]: $progdir/$program\" ", f);
  fputs ("1>&2\n", f);
