...
/* examples/.libs/lt-simple.c - temporary wrapper executable for .libs/simple.exe
   Generated by libtool (GNU libtool) 2.4.2.418

   The examples/simple program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "simple.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# examples/simple - temporary wrapper script for .libs/simple.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2.418\n", f);
  fputs ("#\n", f);
  fputs ("# The examples/simple program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"simple.exe:examples/simple:$LINENO: libtool wrapper (GNU libtool) 2.4", f);
  fputs (".2.418\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"simple.exe:examples/simple:$LINENO: newargv[$lt_dump_args_N]: $lt_ar", f);
  fputs ("g\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"simple.exe:examples/simple:$LINENO: newargv[0]: $progdir/$progra", f);
  fputs ("m\" 1>&2\n", f);
