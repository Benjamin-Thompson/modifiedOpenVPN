...
/* examples/.libs/lt-precomp2.c - temporary wrapper executable for .libs/precomp2.exe
   Generated by libtool (GNU libtool) 2.4.2.418

   The examples/precomp2 program cannot be directly executed until all the libtool
...
const char * LIB_PATH_VALUE   = "C:/dev/7tunnels/openvpn-build-master/generic/tmp/lzo-2.09/src/.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:/dev/7tunnels/openvpn-build-master/generic/tmp/lzo-2.09/src/.libs;//lib;//bin;";
const char * TARGET_PROGRAM_NAME = "precomp2.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# examples/precomp2 - temporary wrapper script for .libs/precomp2.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2.418\n", f);
  fputs ("#\n", f);
  fputs ("# The examples/precomp2 program cannot be directly executed until all the libto", f);
  fputs ("ol\n", f);
  ...
  fputs ("  notinst_deplibs=' src/liblzo2.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"precomp2.exe:examples/precomp2:$LINENO: libtool wrapper (GNU libtool)", f);
  fputs (" 2.4.2.418\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"precomp2.exe:examples/precomp2:$LINENO: newargv[$lt_dump_args_N]: $l", f);
  fputs ("t_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"precomp2.exe:examples/precomp2:$LINENO: newargv[0]: $progdir/$pr", f);
  fputs ("ogram\" 1>&2\n", f);
  ...
  fputs ("    PATH=/cygdrive/c/dev/7tunnels/openvpn-build-master/generic/tmp/lzo-2.09/src", f);
  fputs ("/.libs://lib://bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/cygdrive/c/dev/7tunnels/openvpn-build-master/generic/tmp/lzo-2.09/sr", f);
  fputs ("c/.libs:$PATH\"\n", f);
  fputs ("\n", f);
