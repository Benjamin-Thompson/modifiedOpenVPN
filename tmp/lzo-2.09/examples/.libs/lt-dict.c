...
/* examples/.libs/lt-dict.c - temporary wrapper executable for .libs/dict.exe
   Generated by libtool (GNU libtool) 2.4.2.418

   The examples/dict program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "dict.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# examples/dict - temporary wrapper script for .libs/dict.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2.418\n", f);
  fputs ("#\n", f);
  fputs ("# The examples/dict program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"dict.exe:examples/dict:$LINENO: libtool wrapper (GNU libtool) 2.4.2.4", f);
  fputs ("18\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"dict.exe:examples/dict:$LINENO: newargv[$lt_dump_args_N]: $lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"dict.exe:examples/dict:$LINENO: newargv[0]: $progdir/$program\" 1", f);
  fputs (">&2\n", f);
