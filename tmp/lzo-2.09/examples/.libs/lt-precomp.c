...
/* examples/.libs/lt-precomp.c - temporary wrapper executable for .libs/precomp.exe
   Generated by libtool (GNU libtool) 2.4.2.418

   The examples/precomp program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "precomp.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# examples/precomp - temporary wrapper script for .libs/precomp.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2.418\n", f);
  fputs ("#\n", f);
  fputs ("# The examples/precomp program cannot be directly executed until all the libtoo", f);
  fputs ("l\n", f);
  ...
  fputs ("    echo \"precomp.exe:examples/precomp:$LINENO: libtool wrapper (GNU libtool) 2", f);
  fputs (".4.2.418\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"precomp.exe:examples/precomp:$LINENO: newargv[$lt_dump_args_N]: $lt_", f);
  fputs ("arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"precomp.exe:examples/precomp:$LINENO: newargv[0]: $progdir/$prog", f);
  fputs ("ram\" 1>&2\n", f);
