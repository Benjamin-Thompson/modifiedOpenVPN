...
/* examples/.libs/lt-lzopack.c - temporary wrapper executable for .libs/lzopack.exe
   Generated by libtool (GNU libtool) 2.4.2.418

   The examples/lzopack program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "lzopack.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# examples/lzopack - temporary wrapper script for .libs/lzopack.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2.418\n", f);
  fputs ("#\n", f);
  fputs ("# The examples/lzopack program cannot be directly executed until all the libtoo", f);
  fputs ("l\n", f);
  ...
  fputs ("    echo \"lzopack.exe:examples/lzopack:$LINENO: libtool wrapper (GNU libtool) 2", f);
  fputs (".4.2.418\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"lzopack.exe:examples/lzopack:$LINENO: newargv[$lt_dump_args_N]: $lt_", f);
  fputs ("arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"lzopack.exe:examples/lzopack:$LINENO: newargv[0]: $progdir/$prog", f);
  fputs ("ram\" 1>&2\n", f);
