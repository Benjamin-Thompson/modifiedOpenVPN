...
/* lzotest/.libs/lt-lzotest.c - temporary wrapper executable for .libs/lzotest.exe
   Generated by libtool (GNU libtool) 2.4.2.418

   The lzotest/lzotest program cannot be directly executed until all the libtool
...
const char * TARGET_PROGRAM_NAME = "lzotest.exe"; /* hopefully, no .exe */
...
void lt_dump_script (FILE* f)
{
  fputs ("#! /bin/sh\n", f);
  fputs ("\n", f);
  fputs ("# lzotest/lzotest - temporary wrapper script for .libs/lzotest.exe\n", f);
  fputs ("# Generated by libtool (GNU libtool) 2.4.2.418\n", f);
  fputs ("#\n", f);
  fputs ("# The lzotest/lzotest program cannot be directly executed until all the libtool\n", f);
  ...
  fputs ("    echo \"lzotest.exe:lzotest/lzotest:$LINENO: libtool wrapper (GNU libtool) 2.", f);
  fputs ("4.2.418\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"lzotest.exe:lzotest/lzotest:$LINENO: newargv[$lt_dump_args_N]: $lt_a", f);
  fputs ("rg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"lzotest.exe:lzotest/lzotest:$LINENO: newargv[0]: $progdir/$progr", f);
  fputs ("am\" 1>&2\n", f);
